...
CREATE_PROFILE_FOR_USER_QUERY = """
    INSERT INTO profiles (first_name, last_name, phone_number, licence_number, licence_category,
     licence_expire_date, image, user_id)
    VALUES (:first_name, :last_name, :phone_number, :licence_number, :licence_category,
    :licence_expire_date, :image, :user_id)
    RETURNING id, first_name, last_name, phone_number, licence_number, licence_category,
